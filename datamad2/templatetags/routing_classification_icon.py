...
def icon(value):
    if value == "Marine":
        return mark_safe("<a id='science-icon' title='Marine' data-toggle='tooltip'><i class='fa fa-fish fa-lg' "
                         "style='color:#79e2e8'></i></a>")

    elif value == "Earth":
        return mark_safe("<a id='science-icon' title='Earth' data-toggle='tooltip'><i class='fa fa-seedling fa-lg' "
        ...
        return mark_safe("<a id='science-icon' title='Freshwater' data-toggle='tooltip'><i class='fa fa-water fa-lg' "
                         "style='color:#81aae3'></i></a>")

    elif value == "Terrestrial":
        return mark_safe("<a id='science-icon' title='Terrestrial' data-toggle='tooltip'><i class='fa "
